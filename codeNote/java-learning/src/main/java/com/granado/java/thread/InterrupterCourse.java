 ...
 * public boolean isInterrupted() // 该线程对象的中断状态
 * public static boolean interrupted() // 静态方法，用来判断当前线程是否中断了
 *
 ...
 * 对于 ReentrantLock，线程在竞争锁的时候是进入 WAITING 状态，并且中断时会接收到 IllegalMonitorStateException 异常。
 * LockSupport 底层是使用 Unsafe 的 park 方法，会使线程进入 WAITING 或者 WAITING_TIMED 状态。
 */
