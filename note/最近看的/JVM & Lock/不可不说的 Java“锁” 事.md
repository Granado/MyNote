> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 https://mp.weixin.qq.com/s/E2fOUHOabm10k_EVugX08g

## **前言**

<section class="" style="font-size: 16px;letter-spacing: 0px;white-space: normal;color: rgb(62, 62, 62);line-height: 1.6;margin-left: 0.5em;margin-right: 0.5em;">
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7aNvORaIktWZgicKekEn5YS5ULbJsgdUvfSHibrSEj3EnVMzHf53ykYnjA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7ayRG0ezibGQf6E0G7XqoS0MlVNPhdjwcsMIfFCibVpQLia3MsFp31nDTwg/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsUWxF3IJSFicIicbpueYm7MoK4loCutSFtHGia0nA3E03EicdR6RvAre1yTicYE4sn9wfcefeNohnjK9mw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hEx03cFgUsUWxF3IJSFicIicbpueYm7MoK4ohruwoeTuC4HOn8iacXFRI10WWtAO03eNouuibhzL0s79PZykkoknpQ/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hEx03cFgUsUWxF3IJSFicIicbpueYm7MoKdZicdRV63Jc8goSpSqPZylz9wjuCgiaRkljdDCFJxicucujVPiaoKmjG6w/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7atsAOXEVNheMmSrqJ9Wo1cmgxVv9kB26bjB2TDxz9kp1vrWel8rJKrw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hEx03cFgUsUWxF3IJSFicIicbpueYm7MoKsZBAI0rBWWKExOMLMicicu64mM3aakqZWMnfUEgXxGLhDIQhR63SqLhA/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7aPyc0L5Dn6L5mupGBVuofgnFThXAmmBvZwhk2FRpj0dc7BRpfe6GWlA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hEx03cFgUsUWxF3IJSFicIicbpueYm7MoKm1LZdLiccu4M4FTLJibfGDCAxcP6C8MlD2g6reTaNKdndbGqfu4tqiafw/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7aMicQiac3DLderXYsPzDntK85iagAABxsPkzWtic6APicnKuG0JZDiceMvEkg/640?wx_fmt=png)

如上图所示，假设有一口水井，有管理员看守，管理员有一把锁，只有拿到锁的人才能够打水，打完水要把锁还给管理员。每个过来打水的人都要管理员的允许并拿到锁之后才能去打水，如果前面有人正在打水，那么这个想要打水的人就必须排队。管理员会查看下一个要去打水的人是不是队伍里排最前面的人，如果是的话，才会给你锁让你去打水；如果你不是排第一的人，就必须去队尾排队，这就是公平锁。

但是对于非公平锁，管理员对打水的人没有要求。即使等待队伍里有排队等待的人，但如果在上一个人刚打完水把锁还给管理员而且管理员还没有允许等待队伍里下一个人去打水时，刚好来了一个插队的人，这个插队的人是可以直接从管理员那里拿到锁去打水，不需要排队，原本排队等待的人只能继续等待。如下图所示：

![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7aoXfne8plofqvr8oCVRUwscEonjutotvicS3borZ1xKY3W35KHIhqBIQ/640?wx_fmt=png)

接下来我们通过 ReentrantLock 的源码来讲解公平锁和非公平锁。

![](https://mmbiz.qpic.cn/mmbiz_jpg/hEx03cFgUsUWxF3IJSFicIicbpueYm7MoKy8L55ZOKDI0tnRw74XvTR0sUgzceubtjkxMC3awlEdVqzu1YUqvEAA/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7aN2r1YicfsKWuibcdJ2996VOlslIwgpwtjYEwCdS9M0WVusy8xL8XGOqg/640?wx_fmt=png)

通过上图中的源代码对比，我们可以明显的看出公平锁与非公平锁的 lock() 方法唯一的区别就在于公平锁在获取同步状态时多了一个限制条件：hasQueuedPredecessors()。</section>

![](https://mmbiz.qpic.cn/mmbiz_jpg/hEx03cFgUsUWxF3IJSFicIicbpueYm7MoKQAjz6G48LnP2yzfA1ZbSUMBic1dBMyxMian5oSW0fYz7CwXNS6zGxLZg/640?wx_fmt=jpeg)

<section class="" style="font-size: 16px;letter-spacing: 0px;white-space: normal;color: rgb(62, 62, 62);line-height: 1.6;margin-left: 0.5em;margin-right: 0.5em;">再进入 hasQueuedPredecessors()，可以看到该方法主要做一件事情：主要是判断当前线程是否位于同步队列中的第一个。如果是则返回 true，否则返回 false。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/hEx03cFgUsUWxF3IJSFicIicbpueYm7MoKLgLXJF1wsy176whx1VXDS0AnTAicWibmmH9vjq8cCzNTrGCicadSsAnGg/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7aeUJpuv8OqtQ6Wxx4o2QQzYddTpYgsAhxl4gABpJrbXCCrrxv4eSKog/640?wx_fmt=png)

但如果是非可重入锁的话，此时管理员只允许锁和同一个人的一个水桶绑定。第一个水桶和锁绑定打完水之后并不会释放锁，导致第二个水桶不能和锁绑定也无法打水。当前线程出现死锁，整个等待队列中的所有线程都无法被唤醒。</section>

![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7aWIiak9zgQ3Mic4pIxcxn7oLplME8kjubPwiabeKnUz4ibVvwaL6svNTo4A/640?wx_fmt=png)

<section class="" style="font-size: 16px;letter-spacing: 0px;white-space: normal;line-height: 1.6;margin-left: 0.5em;margin-right: 0.5em;">之前我们说过 ReentrantLock 和 synchronized 都是重入锁，那么我们通过重入锁 ReentrantLock 以及非可重入锁 NonReentrantLock 的源码来对比分析一下为什么非可重入锁在重复调用同步资源时会出现死锁。
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7aay4Ds7sfFExRdsFAgnIB8CvsE49YfoeytS3hp8JJmuibaDedx85xV0Q/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7aWazYOsalicGsSCfe4Qa6MdWrAr6LRRZERa772UAuFXKiclnt7vXYNSUg/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7aUpVCDzUWQMLx2zVYI9ZvibVmRv4r1TYiaHIhAiaJ2fTu3drCEkjUP3KDA/640?wx_fmt=png)

了解了概念之后我们再来看代码，先看写锁的加锁源码：

![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsUWxF3IJSFicIicbpueYm7MoK6c6s9TAnUbp3GVsACzylPEsY9icicf2ibzIkSUnsI4bzNNo45OZzicIVuA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsUWxF3IJSFicIicbpueYm7MoK2gLzj1JdQdicVCqgWFXID0DPnsbgmemdsSJ8OIZVqaYHlYbic0OtTXxg/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/hEx03cFgUsXibicYtRt824nicRjKGTibicl7akVcxczUO1NOBlSBGYlibr9XZDNRSSaEgdiaj0JLnA7mh71WdLsjalW8w/640?wx_fmt=png)
